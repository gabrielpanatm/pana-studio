...
> **Stadiu:** versiune publică de test `0.1.3`. Interfața este disponibilă în română și engleză,
...
```bash
sha256sum --check "Pana.Studio_0.1.3_amd64.AppImage.sha256"
chmod +x "Pana.Studio_0.1.3_amd64.AppImage"
./"Pana.Studio_0.1.3_amd64.AppImage"
```
...
Un tag Git cu forma `v0.1.3` pornește workflow-ul de release pe Ubuntu 22.04.
