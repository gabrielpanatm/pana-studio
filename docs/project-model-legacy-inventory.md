...
| `read_project_model_with_drafts` | comandă/API frontend care accepta drafturi, dar le ignora | modelul intern derivat din `ProjectWorkspace` | ambele comenzi publice, registry-ul, wrapper-ele TS și permisiunile au fost eliminate |
