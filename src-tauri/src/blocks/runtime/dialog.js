(function () {
  "use strict";
  /* PANA BLOCK PROVIDER: dialog */
  var runtime = window.PanaBlockRuntime;
  if (!runtime) throw new Error("PanaBlockRuntime core lipsește pentru providerul dialog.");
  ...
  runtime.register("dialog", overlayDefinition("dialog"));
})();
