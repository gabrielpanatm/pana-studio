...
pub enum KernelEventKind {
    ...
    CssEditAuthorityCommitted,
    CssEditRetryableStale,
    CssEditSuperseded,
    CssEditRejected,
    CssInspectorReadApplied,
    CssInspectorReadRetryableStale,
    CssInspectorReadSuperseded,
    CssInspectorReadRejected,
...
fn event_name(kind: KernelEventKind) -> &'static str {
    match kind {
        ...
        KernelEventKind::CssEditAuthorityCommitted => "kernel.css.edit.authority_committed",
        KernelEventKind::CssEditRetryableStale => "kernel.css.edit.retryable_stale",
        KernelEventKind::CssEditSuperseded => "kernel.css.edit.superseded",
        KernelEventKind::CssEditRejected => "kernel.css.edit.rejected",
        KernelEventKind::CssInspectorReadApplied => "kernel.css.inspector.read.applied",
        KernelEventKind::CssInspectorReadRetryableStale => {
            "kernel.css.inspector.read.retryable_stale"
        }
        KernelEventKind::CssInspectorReadSuperseded => "kernel.css.inspector.read.superseded",
        KernelEventKind::CssInspectorReadRejected => "kernel.css.inspector.read.rejected",
