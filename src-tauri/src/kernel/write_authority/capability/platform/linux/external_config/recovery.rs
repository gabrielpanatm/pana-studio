use super::super::{
    capability_error, fs, sync_directory, wal_identity_from_fd, ExternalConfigRecoveryAction,
    ExternalConfigRecoveryAssessment, OwnedFd, RecoveryReadBudget, RenameFlags,
    WalExternalConfigEvidence, WalExternalOperatorDecision, WalExternalStageCheckpoint,
    WalOperationEvidence, WalPhase, WalRecord, WriteAuthorityRecoveryClassification,
    WAL_EXTERNAL_CONFIG_PROTOCOL_VERSION,
};
#[cfg(test)]
use super::super::{
    WalAtomicFileEvidence, WalFilesystemIdentity, WalLeafEvidence, WalParentEvidence,
};
use super::snapshot::{validate_leaf_absent_for_external, validate_open_external_baseline};

mod snapshot;

use snapshot::{
    capture_external_recovery_context, external_conflict, observe_external_oracle,
    observed_matches_before, observed_matches_checkpointed_before, observed_matches_new,
    open_exact_external_baseline, ready_external_context, reserve_external_before_read,
    sync_exact_external_new, verify_committed_pair, ExternalOracle, ExternalRecoveryContext,
