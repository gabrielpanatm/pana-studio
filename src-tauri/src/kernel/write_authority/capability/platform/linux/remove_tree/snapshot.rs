use super::super::{
    capability_error, encode_component_hex, fs, open_directory_strict,
    tree_fingerprint_from_records, validate_open_directory_identity, version_token_for_stat,
    AtFlags, Dir, FileType, OsStr, OsString, OwnedFd, TreeFingerprintRecord, MAX_REMOVE_TREE_DEPTH,
