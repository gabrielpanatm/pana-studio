  function ensureInspectorStyles() {
    ...
    if (!styleElement) {
      ...
      styleElement.textContent =
        ...
        "." + ACTIVE_DOCUMENT_ROOT_CLASS + " { display: block !important; min-height: var(--pana-active-authoring-min-height, 52px) !important; outline-color: rgba(59,130,246,0.62) !important; background-image: linear-gradient(135deg, rgba(59,130,246,0.08), rgba(59,130,246,0.02)) !important; }\n" +
        ...
        "." + ACTIVE_DOCUMENT_ROOT_CLASS + "[data-pana-empty-label]::before { color: #1d4ed8; border-color: rgba(59,130,246,0.24); }";
