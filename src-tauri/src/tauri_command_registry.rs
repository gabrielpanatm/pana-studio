...
macro_rules! pana_tauri_commands {
    ($consumer:ident) => {
        $consumer!(
            ...
            export_project_asset_data_url,
            export_project_asset_webp_from_data_url,
            ...
            read_mood_board_image_data_url,
            read_mood_board_image_original_data_url,
            read_mood_board_svg_source,
            extract_mood_board_image_palette,
            read_project_env,
            save_project_env,
            read_zola_base_url,
            save_zola_base_url,
